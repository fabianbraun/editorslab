...
NZZ.cookies = {
    ...
    create: function(name, value, seconds, path) {
        ...
        if (seconds != 0) {
            ...
            var strExpires = ' expires=' + expires.toUTCString() + ';';
        }
        document.cookie = name + '=' + value + ';' + strExpires + ' path=' + path;
    },
    ...
    enabled: function() {
        ...
        if (!cookieEnabled) {
            this.create('nzzcookieschk', '1', 1);
            if (this.read('nzzcookieschk') != null) {
                this.erase('nzzcookieschk');
                cookieEnabled = true;
            }
        }
